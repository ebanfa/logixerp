    ...
    var ActivityModel = Backbone.Model.extend({
        ...
        validate: function (attrs) {
            ...
            if (!attrs.businessObjectName) {
                errors.push({name: 'business object name', message: entities_strings.alantra_form_field_required + entities_strings.activity_code + '.'});
            }
            if (!attrs.activityURL) {
                errors.push({name: 'activity URL', message: entities_strings.alantra_form_field_required + entities_strings.activity_name + '.'});
            }
