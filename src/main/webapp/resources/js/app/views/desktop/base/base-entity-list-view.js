...
define([
    ...
    'text!../../../../../templates/desktop/activity/list-counter.html'
], function (utilities, config, entities_strings, formUtilities, QUI, 
		EntitySearchDialogView, ListTableTemplate, ListActivityTemplate, CounterViewTemplate) {
	...
	var CounterView = Backbone.View.extend({
	    ...
	    render: function () 
	    { 
	    	utilities.applyTemplate($('#recordCounterDiv'), CounterViewTemplate, 
	    	{
    ...
    var ListActivityView = Backbone.View.extend(
    {
        initialize: function(options)
        {
			...
			this.counterView = new CounterView({count: 0});
       ...
       /**
        ...
        events:
        {
            ...
            'click  .code-cell':'handleCodeLinkClicked',
        },
        ...
        */
        showEntityCreateView: function(event)
        {
        	if(this.activity.entityName){
                var activityEditURL = "edit/edit_" + this.activity.entityName.toLowerCase() + "/";
        ...
        */
        ...
        onSearchSuccessCallBack: function (self)
	    {
        	return function(data, textStatus) {
        		...
        		self.counterView.reload(data.dataList.length);
			};
        },
        ...
        */
        ...
        handleCodeLinkClicked: function(event){
        	event.preventDefault();
        },
