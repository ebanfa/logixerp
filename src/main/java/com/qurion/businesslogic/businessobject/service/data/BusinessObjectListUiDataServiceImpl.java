 ...
 */
@Stateless
@BusinessObjectListUiDataService
public class BusinessObjectListUiDataServiceImpl implements UiQueryDataService {
	...
	public List<BusinessObjectData> find(Map<String, Object> context)
		...
		List<BusinessObjectFieldData> businessObjectFields = 
				activityService.getBusinessObjectFields(businessObjectData.getBusinessObjectName());
		// 2. Get the business object name and create a search data
		SearchData searchData = new SearchData(businessObjectData.getBusinessObjectName());
