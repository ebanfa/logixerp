...
public class InvoiceStatusType  extends BaseEntity implements java.io.Serializable {
    ...
    public InvoiceStatusType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public InvoiceStatusType(String name, String description, Set invoiceStatuses, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
