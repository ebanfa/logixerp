...
public class WorkEffortPartyAssignment  extends BaseEntity implements java.io.Serializable {
	private Party party;
    ...
    public WorkEffortPartyAssignment(Date fromDt, BigDecimal allocCost, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.fromDt = fromDt;
    ...
    public WorkEffortPartyAssignment(Party party, WorkEffort workEffort, Date fromDt, Date toDt, BigDecimal allocCost, String comment, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.party = party;
