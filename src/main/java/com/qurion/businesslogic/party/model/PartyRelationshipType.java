...
public class PartyRelationshipType  extends BaseEntity implements java.io.Serializable {
    ...
    public PartyRelationshipType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public PartyRelationshipType(String name, String description, Set partyRelationships, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
