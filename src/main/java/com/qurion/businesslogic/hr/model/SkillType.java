...
public class SkillType  extends BaseEntity implements java.io.Serializable {
    ...
    public SkillType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public SkillType(String name, String description, Set workEffortSkillStandards, Set partySkills, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
    ...
    @OneToMany(fetch=FetchType.LAZY, mappedBy="skillType")
    @JsonIgnore
