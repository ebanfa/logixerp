...
public class TerminationReason  extends BaseEntity implements java.io.Serializable {
    ...
    public TerminationReason(String name, String description, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
    ...
    public TerminationReason(String name, String description, Set partyRelationships, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
        this.description = description;
