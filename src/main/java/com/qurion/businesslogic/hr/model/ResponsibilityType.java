...
public class ResponsibilityType  extends BaseEntity implements java.io.Serializable {
    ...
    public ResponsibilityType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public ResponsibilityType(String name, String description, Set positionResponsibilities, Set validResponsibilities, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
    ...
    @OneToMany(fetch=FetchType.LAZY, mappedBy="responsibilityType")
    @JsonIgnore
