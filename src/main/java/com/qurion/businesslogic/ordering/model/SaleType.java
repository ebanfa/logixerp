...
public class SaleType  extends BaseEntity implements java.io.Serializable {
    ...
    public SaleType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public SaleType(String name, String description, Set productPriceComponents, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
    ...
    @OneToMany(fetch=FetchType.LAZY, mappedBy="saleType")
    @JsonIgnore
