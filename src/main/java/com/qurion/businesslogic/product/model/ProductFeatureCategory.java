...
public class ProductFeatureCategory  extends BaseEntity implements java.io.Serializable {
    ...
    public ProductFeatureCategory(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public ProductFeatureCategory(String name, String description, Set productFeatures, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
