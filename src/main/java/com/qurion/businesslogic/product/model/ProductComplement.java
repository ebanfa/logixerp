...
public class ProductComplement  extends BaseEntity implements java.io.Serializable {
    ...
    public ProductComplement(String name, Date fromDt, Date toDt, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.fromDt = fromDt;
        this.toDt = toDt;
