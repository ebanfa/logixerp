...
public class ProductFeatureApplicabilityType  extends BaseEntity implements java.io.Serializable {
    ...
    public ProductFeatureApplicabilityType(String name, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.id = id;
        this.code = code;
    ...
    public ProductFeatureApplicabilityType(String name, String description, Set productFeatureApplicabilities, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
        this.name = name;
