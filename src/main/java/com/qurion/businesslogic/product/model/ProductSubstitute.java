...
public class ProductSubstitute  extends BaseEntity implements java.io.Serializable {
    ...
    public ProductSubstitute(String name, Date fromDt, Date toDt, Integer id, String code, Date effectiveDt, Character recSt, Date createdDt, String createdByUsr) 
    {
        this.name = name;
        this.fromDt = fromDt;
        this.toDt = toDt;
    ...
    public ProductSubstitute(Product productByInProdId, Product productByForProdId, String name, String description, Date fromDt, Date toDt, Integer quantity, String comment, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
