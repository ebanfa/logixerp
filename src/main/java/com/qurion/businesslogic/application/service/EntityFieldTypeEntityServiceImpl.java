 ...
 */
@Stateless
public class EntityFieldTypeEntityServiceImpl 
	extends AbstractEntityServiceImpl<EntityFieldType> 
	implements EntityFieldTypeEntityService
{
	private static final String ENTITY_NAME = "EntityFieldType";
	
	private Logger logger = LoggerFactory.getLogger(EntityFieldTypeEntityServiceImpl.class);
	 ...
	 * @param entityClass
	 */
	public EntityFieldTypeEntityServiceImpl() {
		super(EntityFieldType.class);
	}

    /* (non-Javadoc)
	 * @see com.qurion.businesslogic.entityFieldType.service.EntityFieldType#findById(java.lang.Integer)
	 */
	@Override
	public EntityFieldType findById(Integer id) throws ApplicationException {
		return getSingleInstance(id);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.entityFieldType.service.EntityFieldType#findByCode(java.lang.String)
	 */
	@Override
	public EntityFieldType findByCode(String code) throws ApplicationException {
		return findInstanceByCode(code);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.application.service.EntityFieldType#findByName(java.lang.String)
	 */
	@Override
	public EntityFieldType findByName(String name) throws ApplicationException {
		return findInstanceByName(name);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.application.service.EntityFieldType#findAll(java.util.Map)
	 */
	@Override
	public List<EntityFieldType> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<EntityFieldType> root) 
	{
