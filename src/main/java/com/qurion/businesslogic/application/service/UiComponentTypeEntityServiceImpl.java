 ...
 */
@Stateless
public class UiComponentTypeEntityServiceImpl 
	extends AbstractEntityServiceImpl<UiComponentType> 
	implements UiComponentTypeEntityService
{
	private static final String ENTITY_NAME = "UiComponentType";
	
	private Logger logger = LoggerFactory.getLogger(UiComponentTypeEntityServiceImpl.class);
	 ...
	 * @param entityClass
	 */
	public UiComponentTypeEntityServiceImpl() {
		super(UiComponentType.class);
	}

    /* (non-Javadoc)
	 * @see com.qurion.businesslogic.uiComponentType.service.UiComponentType#findById(java.lang.Integer)
	 */
	@Override
	public UiComponentType findById(Integer id) throws ApplicationException {
		return getSingleInstance(id);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.uiComponentType.service.UiComponentType#findByCode(java.lang.String)
	 */
	@Override
	public UiComponentType findByCode(String code) throws ApplicationException {
		return findInstanceByCode(code);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.application.service.UiComponentType#findByName(java.lang.String)
	 */
	@Override
	public UiComponentType findByName(String name) throws ApplicationException {
		return findInstanceByName(name);
	}

	/* (non-Javadoc)
	 * @see com.qurion.businesslogic.application.service.UiComponentType#findAll(java.util.Map)
	 */
	@Override
	public List<UiComponentType> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
	 ...
	 * 
	 */
	private void initializeQueryParameters(Integer uiComponentTypeId, String name, String description, Integer id, String code, Date effectiveDt, Character recSt, Integer versionNo, Date rowTs, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) {
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<UiComponentType> root) 
	{
